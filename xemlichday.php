...
<body >
    ...
    <li class="hvr-sweep-to-right hvr-ripple-out"><a href="thongtinnv.php">Thông tin cá nhân</a></li>
    </ul>
    </div>
    <div id="noidung">    
    <p style="color: pink; font-weight: bold;font-size: 20px">Đây là trang Xem lịch dạy của giáo viên</p>
    </div>
    </div>    
  </div>
  <!--Chân web -->
